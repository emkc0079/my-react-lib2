...
function je() {
  ...
  return R.Fragment = p, R.jsx = x, R.jsxs = x, R;
}
var j = {};
/**
 * @license React
...
` + l[a].replace(
    ...
    function J(e, r, o, n, u, a) {
      if (typeof e == "string" || typeof e == "function" || e === N || e === F || e === B || e === Y || e === M || e === Te || typeof e == "object" && e !== null && (e.$$typeof === W || e.$$typeof === $ || e.$$typeof === Z || e.$$typeof === L || e.$$typeof === P || e.$$typeof === we || e.getModuleId !== void 0)) {
        var t = r.children;
        if (t !== void 0)
          if (n)
            if (U(t)) {
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (t = null, o !== void 0 && (x(o), t = "" + o), Ee(r) && (x(r.key), t = "" + r.key), "key" in r) {
        o = {};
        for (var T in r)
          T !== "key" && (o[T] = r[T]);
      } else
...
var Ce = G.exports;
const ke = ({ label: c }) => /* @__PURE__ */ Ce.jsx("div", { children: c });
export {
  ke as Text
};
